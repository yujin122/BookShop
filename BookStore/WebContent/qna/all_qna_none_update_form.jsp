		...
		<jsp:include page="../include/help_side.jsp" />
			...
			<div class = "main_box">
				<h3 id = "main_title">Q&A 수정</h3>
					<form method="post" action="all_qna_update.do" class="form-inline" onsubmit="return non_update_check()">
					...
					<div id = "all_qna_form_box">
						...
						<table>
							...
							<tr>
								<td><span>이름</span> <input type="text" class="form-control" name="name" id="name" size="20" value="${qna.getAq_writer() }"></td>
							</tr>
							<tr>
								<td><input type="text" class="form-control" name="title" id="title" placeholder="제목을 입력해주세요" value="${qna.getAq_title() }"></td>
							</tr>
							<tr>
								<td><textarea rows="30" class="form-control" name="cont" id="cont" placeholder="문의할 내용을 입력해주세요">${qna.getAq_content() }</textarea></td>
							</tr>
							<tr>
